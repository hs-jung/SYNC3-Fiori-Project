		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "재고 현황 관리",
									"targetURL": "#camtmonitoring-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"camtmonitoring-display": {
								"semanticObject": "camtmonitoring",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=camtmonitoring",
									"url": sap.ui.require.toUrl("camtmonitoring")
								}
							}
						}
					}
