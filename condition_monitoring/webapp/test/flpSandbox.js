		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#conditionmonitoring-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"conditionmonitoring-display": {
								"semanticObject": "conditionmonitoring",
								"action": "display",
								"description": "재배 환경 모니터링",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=conditionmonitoring",
									"url": sap.ui.require.toUrl("conditionmonitoring")
								}
							}
						}
					}
